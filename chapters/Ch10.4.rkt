...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname Ch10.4) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(define (editor-text l)
  (text (lo1s->string l) FONT-SIZE FONT-COLOR))
